...
bin/run_kmeans_serial: obj/run_kmeans_serial.o obj/kmeans_serial.o obj/cifar10_data.o obj/iris_data.o obj/wine_data.o
	g++ -o bin/run_kmeans_serial obj/run_kmeans_serial.o obj/kmeans_serial.o obj/cifar10_data.o obj/iris_data.o obj/wine_data.o $(GCC_OPTS)

bin/run_kmeans_parallel: obj/run_kmeans_parallel.o obj/kmeans_parallel.o obj/cifar10_data.o obj/iris_data.o obj/cudaTimer.o obj/wine_data.o
	$(NVCC) -o bin/run_kmeans_parallel obj/run_kmeans_parallel.o obj/kmeans_parallel.o obj/cifar10_data.o obj/iris_data.o obj/cudaTimer.o obj/wine_data.o $(NVCC_OPTS)
