...
bin/test_kmeans_parallel: obj/test_kmeans_parallel.o obj/kmeans_parallel.o obj/cifar10_data.o obj/iris_data.o obj/kmeans_serial.o obj/cudaTimer.o
	$(NVCC) -o bin/test_kmeans_parallel obj/test_kmeans_parallel.o obj/kmeans_parallel.o obj/cifar10_data.o obj/iris_data.o obj/kmeans_serial.o obj/cudaTimer.o $(NVCC_OPTS)
